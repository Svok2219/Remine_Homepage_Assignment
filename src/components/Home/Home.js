...
const Home = () => {
  ...
  <div className="d-md-flex px-10 pt-1 text-center  align-items-center">
    <img className="h-28 px-md-1 rounded-md" src={Logo} alt="Vaiio Naiga" />
  <p className="text-white d-none d-sm-block
  pt-0 pt-sm-1">think out of the trash
  </p>
...
<li class="nav-item active font-weight-bold py-2">
  ...
  <Carousel activeIndex={index} onSelect={handleSelect}>
    ...
    <Carousel.Item style={{height:"500px"}}>
      <img
        ...
        src="https://www.wallpaperflare.com/static/180/767/813/horse-evil-sunset-hd-wallpaper.jpg"
        alt="Third slide"
      />
  ...
  The alarming surge in usage of non-biodegradable plastic products has impacted the ecosystem at hazardous levels leaving the planet choked every single day. Plastile Bangladesh Pvt. Ltd. has been incorporated with the intent to reduce the dumping of plastics in the environment, creating affordable structural materials from the plastic waste and thus creating a better tomorrow for the generations to come.
          ...
          {/* <div className="px-md-5 px-2 pt-5 text-center">
            
            <h1 classname="" style={{color:"#444444"}}>Meadia Coverage</h1>
            <div className="row pt-5">
              <div className="col-md-6 text-left">
               <h5 className="py-2  font-weight-bold" style={{color:"#444444",fontSize:"24px"}}>Hyderabad Gives A New Meaning To Plastic Waste, To Use Paver Tiles Made From Recycled Plastic
               </h5> 
  ...
  <div className="py-4">
  <button className="seemore btn-dark font-weight-bold hover:text-white text-white rounded-sm	px-2 py-2  hover:text-white">see more>></button>
  </div>
  </div>
              <div className="col-md-6  ">
              <h5 className="py-2 font-weight-bold" style={{color:"#444444",fontSize:"24px"}}>India Hoga Clean | Clean-Up Drive in Delhi | CNN News18</h5>               
              <iframe width="100%" height="230" src="https://www.youtube.com/embed/d5nzyJ_2Vks" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" ></iframe>
  ...
  <div class="container">
      <div id="accordion" class="accordion py-3" >
          <div class="card mb-0">
              <div class="card-header collapsed bg-dark text-white" data-toggle="collapse" href="#collapseOne">
                  <a class="font-weight-bold" style={{color:"#eeeeee"}}>
              ...
              <div class="card-header collapsed my-3 " data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
              <a class="font-weight-bold" style={{color:"#483F3A"}}>
              ...
              <div class="card-header collapsed bg-dark text-white" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
              <a class="font-weight-bold" style={{color:"#eeeeee"}}>
                    What are The hidden ultimate purpose of us ?
                  </a>
                   
              </div>
              <div id="collapseThree" class="collapsed" data-parent="#accordion" >
              ...
              <div class="card-header collapsed mt-3" data-toggle="collapse" data-parent="#accordion" href="#collapseFour">
              <a class="font-weight-bold" style={{color:"#483F3A"}}>
  Who is the Dev Guy here?
          ...
          <div id="brands" className=" BrandHeader  px-md-5 py-5">
