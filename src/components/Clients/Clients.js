...
<li class="nav-item active font-weight-bold py-2">
  ...
  <div className="px-md-5 px-2 pt-5 text-center">
            ...
            <h1 classname="" style={{color:"#444444"}}>Our Projects</h1>
   ...
   */}
   ...
   <h1 className="py-5 text-dark font-weight-bold">THIS PAGE IS NOT DEPLOYED YET..<br/><br/>...pLEASE cHECK bACK sOON.....
   <br/> ☺️ </h1>
