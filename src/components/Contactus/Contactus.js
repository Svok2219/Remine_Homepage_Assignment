...
<li class="nav-item active font-weight-bold py-2">
  ...
  <div className="px-md-5 px-5 pt-5 text-center">
   ...
   */}
   <div className="">
   {/* <img className="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTMeNeMI9y6uJSAf6x95xgkpaWTwge08GNdUg&usqp=CAU" alt="this page is under construction" srcset=""/> */}
   <div className="row py-5 ">
       <div className="col-md-7"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29199.78758206945!2d90.43684585026077!3d23.81954321152791!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c62fce7d991f%3A0xacfaf1ac8e944c05!2sBasundhara%20Residential%20Area%2C%20Dhaka!5e0!3m2!1sen!2sbd!4v1613002507067!5m2!1sen!2sbd" width="100%" height="300" frameborder="0" style={{border:0}} ></iframe></div>
       <div className="col-md-5  py-5 text-center text-md-left">
<h4>Plastile Pvt. Ltd. Bangladesh
</h4>
<p><span className="text-dark font-weight-bold ">Address:</span>Plastile Pvt. Ltd. Bashundhara R/A ,G Block,Road1,house 70 1x,Dhaka 1200
</p>

<p><span className="text-dark font-weight-bold">Email:</span>mostakin_rabbi@yahoo.com
</p> 
<p>info@plastile.com</p> 
